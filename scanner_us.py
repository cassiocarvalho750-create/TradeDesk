...
def main():
    ...
    ap.add_argument("--timeframe",default="1d",choices=["1d","1wk","4h","2h","1h","15m","5m"],help="timeframe do grafico")
    a=ap.parse_args()
    tf=a.timeframe
    days=a.days if (a.days is not None and tf=='1d') else sc.default_days_back(tf)
